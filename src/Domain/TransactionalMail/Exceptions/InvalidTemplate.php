...
class InvalidTemplate extends Exception
{
    ...
    public static function replacerNotFound(TransactionalMailTemplate $template, string $replacerName): self
    {
    ...
    public static function invalidReplacer(TransactionalMailTemplate $template, string $replacerName, ?string $replacerClass): self
    {
