...
- {{ __('New subscriptions') }}: <strong>{{ number_format($summary['total_number_of_subscribers_gained']) }}</strong>
- {{ __('Unsubscribes') }}: <strong>{{ number_format($summary['total_number_of_unsubscribes_gained']) }}</strong>
- {{ __('Total number of subscribers') }}: <strong>{{ number_format($summary['total_number_of_subscribers']) }}</strong>
@endcomponent
